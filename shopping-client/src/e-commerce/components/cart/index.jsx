...
const Cart = () => {
    return (
        <div className="cart-container abc">
            <h1>Shopping Cart</h1>
            ...
            <div className="shopping-cart">
                ...
                <div className="product">
                    <div className="product-image">
                        <img src="https://s.cdpn.io/3/dingo-dog-bones.jpg"alt='welcome to RedTape'/>
                    </div>
                ...
                <div className="product">
                    <div className="product-image">
                        <img src="https://s.cdpn.io/3/large-NutroNaturalChoiceAdultLambMealandRiceDryDogFood.png"alt='welcome to RedTape'/>
                    </div>
                    <div className="product-details">
